...
//            faceView.addGestureRecognizer(tapRecognizer)
    ...
    private struct HeadShake {
        ...
        static let segmenyDuration: TimeInterval = 0.5  //each headshake has 3 segments
    }
    ...
    private func shakeHead() {
        UIView.animate(
            withDuration: HeadShake.segmenyDuration,
    ...
    @IBAction func tapToShakeHead(_ sender: UITapGestureRecognizer) {
        shakeHead()
    }
